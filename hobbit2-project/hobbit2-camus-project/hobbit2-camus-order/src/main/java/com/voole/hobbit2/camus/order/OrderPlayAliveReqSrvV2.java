...
public class OrderPlayAliveReqSrvV2 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static com.voole.hobbit2.camus.order.OrderPlayAliveReqSrvV2.Builder newBuilder() {
    return new com.voole.hobbit2.camus.order.OrderPlayAliveReqSrvV2.Builder();
  }
  
  /** Creates a new OrderPlayAliveReqSrvV2 RecordBuilder by copying an existing Builder */
  public static com.voole.hobbit2.camus.order.OrderPlayAliveReqSrvV2.Builder newBuilder(com.voole.hobbit2.camus.order.OrderPlayAliveReqSrvV2.Builder other) {
    return new com.voole.hobbit2.camus.order.OrderPlayAliveReqSrvV2.Builder(other);
  }
  
  /** Creates a new OrderPlayAliveReqSrvV2 RecordBuilder by copying an existing OrderPlayAliveReqSrvV2 instance */
  public static com.voole.hobbit2.camus.order.OrderPlayAliveReqSrvV2.Builder newBuilder(com.voole.hobbit2.camus.order.OrderPlayAliveReqSrvV2 other) {
    return new com.voole.hobbit2.camus.order.OrderPlayAliveReqSrvV2.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderPlayAliveReqSrvV2>
    ...
    private Builder() {
      super(com.voole.hobbit2.camus.order.OrderPlayAliveReqSrvV2.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.voole.hobbit2.camus.order.OrderPlayAliveReqSrvV2.Builder other) {
      super(other);
    ...
    private Builder(com.voole.hobbit2.camus.order.OrderPlayAliveReqSrvV2 other) {
            super(com.voole.hobbit2.camus.order.OrderPlayAliveReqSrvV2.SCHEMA$);
      if (isValidValue(fields()[0], other.srvIP)) {
        this.srvIP = data().deepCopy(fields()[0].schema(), other.srvIP);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'srvIP' field */
    public com.voole.hobbit2.camus.order.OrderPlayAliveReqSrvV2.Builder setSrvIP(java.lang.Long value) {
    ...
    public com.voole.hobbit2.camus.order.OrderPlayAliveReqSrvV2.Builder clearSrvIP() {
      srvIP = null;
    ...
    /** Sets the value of the 'connTimes' field */
    public com.voole.hobbit2.camus.order.OrderPlayAliveReqSrvV2.Builder setConnTimes(java.lang.Long value) {
    ...
    public com.voole.hobbit2.camus.order.OrderPlayAliveReqSrvV2.Builder clearConnTimes() {
      connTimes = null;
    ...
    /** Sets the value of the 'transNum' field */
    public com.voole.hobbit2.camus.order.OrderPlayAliveReqSrvV2.Builder setTransNum(java.lang.Long value) {
    ...
    public com.voole.hobbit2.camus.order.OrderPlayAliveReqSrvV2.Builder clearTransNum() {
      transNum = null;
    ...
    /** Sets the value of the 'avgRTT' field */
    public com.voole.hobbit2.camus.order.OrderPlayAliveReqSrvV2.Builder setAvgRTT(java.lang.Long value) {
    ...
    public com.voole.hobbit2.camus.order.OrderPlayAliveReqSrvV2.Builder clearAvgRTT() {
      avgRTT = null;
    ...
    /** Sets the value of the 'accBytes' field */
    public com.voole.hobbit2.camus.order.OrderPlayAliveReqSrvV2.Builder setAccBytes(java.lang.Long value) {
    ...
    public com.voole.hobbit2.camus.order.OrderPlayAliveReqSrvV2.Builder clearAccBytes() {
      accBytes = null;
    ...
    /** Sets the value of the 'accTime' field */
    public com.voole.hobbit2.camus.order.OrderPlayAliveReqSrvV2.Builder setAccTime(java.lang.Long value) {
    ...
    public com.voole.hobbit2.camus.order.OrderPlayAliveReqSrvV2.Builder clearAccTime() {
      accTime = null;
    ...
    /** Sets the value of the 'avgSpeed' field */
    public com.voole.hobbit2.camus.order.OrderPlayAliveReqSrvV2.Builder setAvgSpeed(java.lang.Long value) {
    ...
    public com.voole.hobbit2.camus.order.OrderPlayAliveReqSrvV2.Builder clearAvgSpeed() {
      avgSpeed = null;

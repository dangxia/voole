...
public class OrderPlayEndReqV2 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public java.util.List<com.voole.hobbit2.camus.order.OrderPlayEndReqSrvV2> getSrvs$1() {
    return _srvs;
  }
   ...
   * @param value the value to set.
   */
  public void setSrvs$1(java.util.List<com.voole.hobbit2.camus.order.OrderPlayEndReqSrvV2> value) {
    this._srvs = value;
  }
  ...
  public static com.voole.hobbit2.camus.order.OrderPlayEndReqV2.Builder newBuilder(com.voole.hobbit2.camus.order.OrderPlayEndReqV2.Builder other) {
    return new com.voole.hobbit2.camus.order.OrderPlayEndReqV2.Builder(other);
  }
  
  /** Creates a new OrderPlayEndReqV2 RecordBuilder by copying an existing OrderPlayEndReqV2 instance */
  public static com.voole.hobbit2.camus.order.OrderPlayEndReqV2.Builder newBuilder(com.voole.hobbit2.camus.order.OrderPlayEndReqV2 other) {
    return new com.voole.hobbit2.camus.order.OrderPlayEndReqV2.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderPlayEndReqV2>
    ...
    private Builder() {
      super(com.voole.hobbit2.camus.order.OrderPlayEndReqV2.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.voole.hobbit2.camus.order.OrderPlayEndReqV2.Builder other) {
      super(other);
    ...
    private Builder(com.voole.hobbit2.camus.order.OrderPlayEndReqV2 other) {
            super(com.voole.hobbit2.camus.order.OrderPlayEndReqV2.SCHEMA$);
      if (isValidValue(fields()[0], other.HID)) {
        this.HID = data().deepCopy(fields()[0].schema(), other.HID);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'HID' field */
    public com.voole.hobbit2.camus.order.OrderPlayEndReqV2.Builder setHID(java.lang.CharSequence value) {
    ...
    public com.voole.hobbit2.camus.order.OrderPlayEndReqV2.Builder clearHID() {
      HID = null;
    ...
    /** Sets the value of the 'UID' field */
    public com.voole.hobbit2.camus.order.OrderPlayEndReqV2.Builder setUID(java.lang.CharSequence value) {
    ...
    public com.voole.hobbit2.camus.order.OrderPlayEndReqV2.Builder clearUID() {
      UID = null;
    ...
    /** Sets the value of the 'localIP' field */
    public com.voole.hobbit2.camus.order.OrderPlayEndReqV2.Builder setLocalIP(java.lang.Long value) {
    ...
    public com.voole.hobbit2.camus.order.OrderPlayEndReqV2.Builder clearLocalIP() {
      localIP = null;
    ...
    /** Sets the value of the 'sessID' field */
    public com.voole.hobbit2.camus.order.OrderPlayEndReqV2.Builder setSessID(java.lang.CharSequence value) {
    ...
    public com.voole.hobbit2.camus.order.OrderPlayEndReqV2.Builder clearSessID() {
      sessID = null;
    ...
    /** Sets the value of the 'perfIp' field */
    public com.voole.hobbit2.camus.order.OrderPlayEndReqV2.Builder setPerfIp(java.lang.Long value) {
    ...
    public com.voole.hobbit2.camus.order.OrderPlayEndReqV2.Builder clearPerfIp() {
      perfIp = null;

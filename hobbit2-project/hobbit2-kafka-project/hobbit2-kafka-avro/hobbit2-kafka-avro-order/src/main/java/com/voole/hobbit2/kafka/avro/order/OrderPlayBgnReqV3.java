...
public class OrderPlayBgnReqV3 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderPlayBgnReqV3\",\"namespace\":\"com.voole.hobbit2.kafka.avro.order\",\"fields\":[{\"name\":\"OEMID\",\"type\":[\"long\",\"null\"]},{\"name\":\"vendorID\",\"type\":[\"long\",\"null\"]},{\"name\":\"curVer\",\"type\":[\"long\",\"null\"]},{\"name\":\"buildTime\",\"type\":[\"long\",\"null\"]},{\"name\":\"HID\",\"type\":[\"string\",\"null\"]},{\"name\":\"UID\",\"type\":[\"string\",\"null\"]},{\"name\":\"localIP\",\"type\":[\"long\",\"null\"]},{\"name\":\"sessID\",\"type\":[\"string\",\"null\"]},{\"name\":\"sessType\",\"type\":[\"int\",\"null\"]},{\"name\":\"sessStatus\",\"type\":[\"int\",\"null\"]},{\"name\":\"FID\",\"type\":[\"string\",\"null\"]},{\"name\":\"mSize\",\"type\":[\"long\",\"null\"]},{\"name\":\"mmime\",\"type\":[\"int\",\"null\"]},{\"name\":\"idxLen\",\"type\":[\"long\",\"null\"]},{\"name\":\"urlLen\",\"type\":[\"int\",\"null\"]},{\"name\":\"URL\",\"type\":[\"string\",\"null\"]},{\"name\":\"playTick\",\"type\":[\"long\",\"null\"]},{\"name\":\"srvNum\",\"type\":[\"int\",\"null\"]},{\"name\":\"_srvs\",\"type\":[\"null\",{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"OrderPlayBgnReqSrvV3\",\"fields\":[{\"name\":\"srvIP\",\"type\":[\"long\",\"null\"]},{\"name\":\"srvPort\",\"type\":[\"int\",\"null\"]},{\"name\":\"srvType\",\"type\":[\"long\",\"null\"]}]}}]},{\"name\":\"cacheSize\",\"type\":[\"long\",\"null\"]},{\"name\":\"packSize\",\"type\":[\"long\",\"null\"]},{\"name\":\"bufSize\",\"type\":[\"long\",\"null\"]},{\"name\":\"natip\",\"type\":[\"long\",\"null\"]}]}");
  ...
  @Deprecated public java.util.List<com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqSrvV3> _srvs;
  ...
  public java.lang.Object get(int field$) {
    ...
    case 19: return cacheSize;
    case 20: return packSize;
    case 21: return bufSize;
    case 22: return natip;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 18: _srvs = (java.util.List<com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqSrvV3>)value$; break;
    case 19: cacheSize = (java.lang.Long)value$; break;
    case 20: packSize = (java.lang.Long)value$; break;
    case 21: bufSize = (java.lang.Long)value$; break;
    case 22: natip = (java.lang.Long)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.List<com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqSrvV3> getSrvs$1() {
    return _srvs;
  }
   ...
   * @param value the value to set.
   */
  public void setSrvs$1(java.util.List<com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqSrvV3> value) {
    this._srvs = value;
  }
  ...
  public static com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder newBuilder() {
    return new com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder();
  }
  
  /** Creates a new OrderPlayBgnReqV3 RecordBuilder by copying an existing Builder */
  public static com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder newBuilder(com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder other) {
    return new com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder(other);
  }
  
  /** Creates a new OrderPlayBgnReqV3 RecordBuilder by copying an existing OrderPlayBgnReqV3 instance */
  public static com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder newBuilder(com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3 other) {
    return new com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderPlayBgnReqV3>
    ...
    private java.util.List<com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqSrvV3> _srvs;
    ...
    private Builder() {
      super(com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[19], other.cacheSize)) {
        this.cacheSize = data().deepCopy(fields()[19].schema(), other.cacheSize);
        fieldSetFlags()[19] = true;
      }
      if (isValidValue(fields()[20], other.packSize)) {
        this.packSize = data().deepCopy(fields()[20].schema(), other.packSize);
        fieldSetFlags()[20] = true;
      }
      if (isValidValue(fields()[21], other.bufSize)) {
        this.bufSize = data().deepCopy(fields()[21].schema(), other.bufSize);
        fieldSetFlags()[21] = true;
      }
      if (isValidValue(fields()[22], other.natip)) {
        this.natip = data().deepCopy(fields()[22].schema(), other.natip);
        fieldSetFlags()[22] = true;
      }
    }
    
    /** Creates a Builder by copying an existing OrderPlayBgnReqV3 instance */
    private Builder(com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3 other) {
            super(com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.SCHEMA$);
      if (isValidValue(fields()[0], other.OEMID)) {
        this.OEMID = data().deepCopy(fields()[0].schema(), other.OEMID);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'OEMID' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder setOEMID(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder clearOEMID() {
      OEMID = null;
    ...
    /** Sets the value of the 'vendorID' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder setVendorID(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder clearVendorID() {
      vendorID = null;
    ...
    /** Sets the value of the 'curVer' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder setCurVer(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder clearCurVer() {
      curVer = null;
    ...
    /** Sets the value of the 'buildTime' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder setBuildTime(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder clearBuildTime() {
      buildTime = null;
    ...
    /** Sets the value of the 'HID' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder setHID(java.lang.CharSequence value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder clearHID() {
      HID = null;
    ...
    /** Sets the value of the 'UID' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder setUID(java.lang.CharSequence value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder clearUID() {
      UID = null;
    ...
    /** Sets the value of the 'localIP' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder setLocalIP(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder clearLocalIP() {
      localIP = null;
    ...
    /** Sets the value of the 'sessID' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder setSessID(java.lang.CharSequence value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder clearSessID() {
      sessID = null;
    ...
    /** Sets the value of the 'sessType' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder setSessType(java.lang.Integer value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder clearSessType() {
      sessType = null;
    ...
    /** Sets the value of the 'sessStatus' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder setSessStatus(java.lang.Integer value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder clearSessStatus() {
      sessStatus = null;
    ...
    /** Sets the value of the 'FID' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder setFID(java.lang.CharSequence value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder clearFID() {
      FID = null;
    ...
    /** Sets the value of the 'mSize' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder setMSize(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder clearMSize() {
      mSize = null;
    ...
    /** Sets the value of the 'mmime' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder setMmime(java.lang.Integer value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder clearMmime() {
      mmime = null;
    ...
    /** Sets the value of the 'idxLen' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder setIdxLen(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder clearIdxLen() {
      idxLen = null;
    ...
    /** Sets the value of the 'urlLen' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder setUrlLen(java.lang.Integer value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder clearUrlLen() {
      urlLen = null;
    ...
    /** Sets the value of the 'URL' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder setURL(java.lang.CharSequence value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder clearURL() {
      URL = null;
    ...
    /** Sets the value of the 'playTick' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder setPlayTick(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder clearPlayTick() {
      playTick = null;
    ...
    /** Sets the value of the 'srvNum' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder setSrvNum(java.lang.Integer value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder clearSrvNum() {
      srvNum = null;
    ...
    /** Sets the value of the '_srvs' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder setSrvs$1(java.util.List<com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqSrvV3> value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder clearSrvs$1() {
      _srvs = null;
    ...
    /** Sets the value of the 'cacheSize' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder setCacheSize(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder clearCacheSize() {
      cacheSize = null;
    ...
    /** Sets the value of the 'packSize' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder setPackSize(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder clearPackSize() {
      packSize = null;
    ...
    /** Sets the value of the 'bufSize' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder setBufSize(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder clearBufSize() {
      bufSize = null;
    ...
    /** Sets the value of the 'natip' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder setNatip(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqV3.Builder clearNatip() {
      natip = null;
    ...
    public OrderPlayBgnReqV3 build() {
      try {
        ...
        record._srvs = fieldSetFlags()[18] ? this._srvs : (java.util.List<com.voole.hobbit2.kafka.avro.order.OrderPlayBgnReqSrvV3>) defaultValue(fields()[18]);
        record.cacheSize = fieldSetFlags()[19] ? this.cacheSize : (java.lang.Long) defaultValue(fields()[19]);
        record.packSize = fieldSetFlags()[20] ? this.packSize : (java.lang.Long) defaultValue(fields()[20]);
        record.bufSize = fieldSetFlags()[21] ? this.bufSize : (java.lang.Long) defaultValue(fields()[21]);
        record.natip = fieldSetFlags()[22] ? this.natip : (java.lang.Long) defaultValue(fields()[22]);
        return record;
      } catch (Exception e) {

...
public class OrderPlayEndReqV3 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.List<com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV3> _srvs;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 12: srvNum = (java.lang.Integer)value$; break;
    case 13: _srvs = (java.util.List<com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV3>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.List<com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV3> getSrvs$1() {
    return _srvs;
  }
   ...
   * @param value the value to set.
   */
  public void setSrvs$1(java.util.List<com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV3> value) {
    this._srvs = value;
  }

  /** Creates a new OrderPlayEndReqV3 RecordBuilder */
  public static com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder newBuilder() {
    return new com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder();
  }
  
  /** Creates a new OrderPlayEndReqV3 RecordBuilder by copying an existing Builder */
  public static com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder newBuilder(com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder other) {
    return new com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder(other);
  }
  
  /** Creates a new OrderPlayEndReqV3 RecordBuilder by copying an existing OrderPlayEndReqV3 instance */
  public static com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder newBuilder(com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3 other) {
    return new com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderPlayEndReqV3>
    ...
    private java.util.List<com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV3> _srvs;

    /** Creates a new Builder */
    private Builder() {
      super(com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[12], other.srvNum)) {
        this.srvNum = data().deepCopy(fields()[12].schema(), other.srvNum);
    ...
    private Builder(com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3 other) {
            super(com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.SCHEMA$);
      if (isValidValue(fields()[0], other.HID)) {
        this.HID = data().deepCopy(fields()[0].schema(), other.HID);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'HID' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder setHID(java.lang.CharSequence value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder clearHID() {
      HID = null;
    ...
    /** Sets the value of the 'UID' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder setUID(java.lang.CharSequence value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder clearUID() {
      UID = null;
    ...
    /** Sets the value of the 'localIP' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder setLocalIP(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder clearLocalIP() {
      localIP = null;
    ...
    /** Sets the value of the 'sessID' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder setSessID(java.lang.CharSequence value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder clearSessID() {
      sessID = null;
    ...
    /** Sets the value of the 'adjPlayTime' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder setAdjPlayTime(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder clearAdjPlayTime() {
      adjPlayTime = null;
    ...
    /** Sets the value of the 'accID' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder setAccID(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder clearAccID() {
      accID = null;
    ...
    /** Sets the value of the 'endTick' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder setEndTick(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder clearEndTick() {
      endTick = null;
    ...
    /** Sets the value of the 'seekNum' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder setSeekNum(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder clearSeekNum() {
      seekNum = null;
    ...
    /** Sets the value of the 'readNum' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder setReadNum(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder clearReadNum() {
      readNum = null;
    ...
    /** Sets the value of the 'unsuccRead' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder setUnsuccRead(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder clearUnsuccRead() {
      unsuccRead = null;
    ...
    /** Sets the value of the 'stopPos' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder setStopPos(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder clearStopPos() {
      stopPos = null;
    ...
    /** Sets the value of the 'sessAvgSpeed' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder setSessAvgSpeed(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder clearSessAvgSpeed() {
      sessAvgSpeed = null;
    ...
    /** Sets the value of the 'srvNum' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder setSrvNum(java.lang.Integer value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder clearSrvNum() {
      srvNum = null;
    ...
    /** Sets the value of the '_srvs' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder setSrvs$1(java.util.List<com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV3> value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqV3.Builder clearSrvs$1() {
      _srvs = null;
    ...
    public OrderPlayEndReqV3 build() {
      try {
        ...
        record.srvNum = fieldSetFlags()[12] ? this.srvNum : (java.lang.Integer) defaultValue(fields()[12]);
        record._srvs = fieldSetFlags()[13] ? this._srvs : (java.util.List<com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV3>) defaultValue(fields()[13]);
        return record;
      } catch (Exception e) {

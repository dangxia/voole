...
public class OrderPlayAliveReqV3 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.List<com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqSrvV3> _srvs;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 12: _srvs = (java.util.List<com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqSrvV3>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.List<com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqSrvV3> getSrvs$1() {
    return _srvs;
  }
   ...
   * @param value the value to set.
   */
  public void setSrvs$1(java.util.List<com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqSrvV3> value) {
    this._srvs = value;
  }

  /** Creates a new OrderPlayAliveReqV3 RecordBuilder */
  public static com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder newBuilder() {
    return new com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder();
  }
  
  /** Creates a new OrderPlayAliveReqV3 RecordBuilder by copying an existing Builder */
  public static com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder newBuilder(com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder other) {
    return new com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder(other);
  }
  
  /** Creates a new OrderPlayAliveReqV3 RecordBuilder by copying an existing OrderPlayAliveReqV3 instance */
  public static com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder newBuilder(com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3 other) {
    return new com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderPlayAliveReqV3>
    ...
    private java.util.List<com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqSrvV3> _srvs;

    /** Creates a new Builder */
    private Builder() {
      super(com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder other) {
      super(other);
    ...
    private Builder(com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3 other) {
            super(com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.SCHEMA$);
      if (isValidValue(fields()[0], other.sessID)) {
        this.sessID = data().deepCopy(fields()[0].schema(), other.sessID);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'sessID' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder setSessID(java.lang.CharSequence value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder clearSessID() {
      sessID = null;
    ...
    /** Sets the value of the 'adjPlayTime' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder setAdjPlayTime(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder clearAdjPlayTime() {
      adjPlayTime = null;
    ...
    /** Sets the value of the 'accID' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder setAccID(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder clearAccID() {
      accID = null;
    ...
    /** Sets the value of the 'aliveTick' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder setAliveTick(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder clearAliveTick() {
      aliveTick = null;
    ...
    /** Sets the value of the 'seekNum' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder setSeekNum(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder clearSeekNum() {
      seekNum = null;
    ...
    /** Sets the value of the 'readNum' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder setReadNum(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder clearReadNum() {
      readNum = null;
    ...
    /** Sets the value of the 'unsuccRead' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder setUnsuccRead(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder clearUnsuccRead() {
      unsuccRead = null;
    ...
    /** Sets the value of the 'readPos' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder setReadPos(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder clearReadPos() {
      readPos = null;
    ...
    /** Sets the value of the 'sessAvgSpeed' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder setSessAvgSpeed(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder clearSessAvgSpeed() {
      sessAvgSpeed = null;
    ...
    /** Sets the value of the 'sessSpeed' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder setSessSpeed(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder clearSessSpeed() {
      sessSpeed = null;
    ...
    /** Sets the value of the 'linkNum' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder setLinkNum(java.lang.Integer value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder clearLinkNum() {
      linkNum = null;
    ...
    /** Sets the value of the 'cacheSizeCur' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder setCacheSizeCur(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder clearCacheSizeCur() {
      cacheSizeCur = null;
    ...
    /** Sets the value of the '_srvs' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder setSrvs$1(java.util.List<com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqSrvV3> value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqV3.Builder clearSrvs$1() {
      _srvs = null;
    ...
    public OrderPlayAliveReqV3 build() {
      try {
        ...
        record._srvs = fieldSetFlags()[12] ? this._srvs : (java.util.List<com.voole.hobbit2.kafka.avro.order.OrderPlayAliveReqSrvV3>) defaultValue(fields()[12]);
        return record;
      } catch (Exception e) {

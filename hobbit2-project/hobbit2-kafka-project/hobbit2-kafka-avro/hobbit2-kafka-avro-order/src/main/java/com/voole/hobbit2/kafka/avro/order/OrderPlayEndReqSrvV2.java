...
public class OrderPlayEndReqSrvV2 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderPlayEndReqSrvV2\",\"namespace\":\"com.voole.hobbit2.kafka.avro.order\",\"fields\":[{\"name\":\"srvIP\",\"type\":[\"long\",\"null\"]},{\"name\":\"connTimes\",\"type\":[\"long\",\"null\"]},{\"name\":\"transNum\",\"type\":[\"long\",\"null\"]},{\"name\":\"avgRTT\",\"type\":[\"long\",\"null\"]},{\"name\":\"accBytes\",\"type\":[\"long\",\"null\"]},{\"name\":\"accTime\",\"type\":[\"long\",\"null\"]},{\"name\":\"avgSpeed\",\"type\":[\"long\",\"null\"]}]}");
   ...
   */
  public OrderPlayEndReqSrvV2(java.lang.Long srvIP, java.lang.Long connTimes, java.lang.Long transNum, java.lang.Long avgRTT, java.lang.Long accBytes, java.lang.Long accTime, java.lang.Long avgSpeed) {
    this.srvIP = srvIP;
  ...
  /** Creates a new OrderPlayEndReqSrvV2 RecordBuilder */
  public static com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV2.Builder newBuilder() {
    return new com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV2.Builder();
  }
  
  /** Creates a new OrderPlayEndReqSrvV2 RecordBuilder by copying an existing Builder */
  public static com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV2.Builder newBuilder(com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV2.Builder other) {
    return new com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV2.Builder(other);
  }
  
  /** Creates a new OrderPlayEndReqSrvV2 RecordBuilder by copying an existing OrderPlayEndReqSrvV2 instance */
  public static com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV2.Builder newBuilder(com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV2 other) {
    return new com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV2.Builder(other);
  }
  
  /**
   * RecordBuilder for OrderPlayEndReqSrvV2 instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderPlayEndReqSrvV2>
    implements org.apache.avro.data.RecordBuilder<OrderPlayEndReqSrvV2> {
    ...
    private Builder() {
      super(com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV2.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV2.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing OrderPlayEndReqSrvV2 instance */
    private Builder(com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV2 other) {
            super(com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV2.SCHEMA$);
      if (isValidValue(fields()[0], other.srvIP)) {
        this.srvIP = data().deepCopy(fields()[0].schema(), other.srvIP);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'srvIP' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV2.Builder setSrvIP(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV2.Builder clearSrvIP() {
      srvIP = null;
    ...
    /** Sets the value of the 'connTimes' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV2.Builder setConnTimes(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV2.Builder clearConnTimes() {
      connTimes = null;
    ...
    /** Sets the value of the 'transNum' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV2.Builder setTransNum(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV2.Builder clearTransNum() {
      transNum = null;
    ...
    /** Sets the value of the 'avgRTT' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV2.Builder setAvgRTT(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV2.Builder clearAvgRTT() {
      avgRTT = null;
    ...
    /** Sets the value of the 'accBytes' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV2.Builder setAccBytes(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV2.Builder clearAccBytes() {
      accBytes = null;
    ...
    /** Sets the value of the 'accTime' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV2.Builder setAccTime(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV2.Builder clearAccTime() {
      accTime = null;
    ...
    /** Sets the value of the 'avgSpeed' field */
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV2.Builder setAvgSpeed(java.lang.Long value) {
    ...
    public com.voole.hobbit2.kafka.avro.order.OrderPlayEndReqSrvV2.Builder clearAvgSpeed() {
      avgSpeed = null;
    ...
    @Override
    public OrderPlayEndReqSrvV2 build() {
      try {
        OrderPlayEndReqSrvV2 record = new OrderPlayEndReqSrvV2();

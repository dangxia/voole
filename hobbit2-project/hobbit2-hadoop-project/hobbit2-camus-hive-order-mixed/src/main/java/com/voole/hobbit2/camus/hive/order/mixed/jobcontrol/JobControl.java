...
public class JobControl implements Runnable {
	...
	private void beforeRemove(ControlledJob j) throws IOException {
		if (j.getJobName().equals(CamusMetaConfigs.getJobName(j.getJob()))) {
			CamusJobCreator.finishJob(j.getJob());

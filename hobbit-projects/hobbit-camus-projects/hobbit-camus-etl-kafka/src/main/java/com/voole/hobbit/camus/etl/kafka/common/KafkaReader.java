...
public class KafkaReader {
	...
	public boolean fetch() throws IOException {
		...
		FetchRequest fetchRequest = new FetchRequest(
				CamusConfigs.getKafkaFetchRequestCorrelationId(context),
				CamusConfigs.getKafkaClientName(context),
				CamusConfigs.getKafkaFetchRequestMaxWait(context),
				CamusConfigs.getKafkaFetchRequestMinBytes(context), fetchInfo);

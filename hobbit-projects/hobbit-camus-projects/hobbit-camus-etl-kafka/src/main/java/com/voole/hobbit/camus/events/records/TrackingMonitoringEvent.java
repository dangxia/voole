...
public class TrackingMonitoringEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: header = (com.voole.hobbit.camus.events.records.EventHeader)value$; break;
   ...
   */
  public com.voole.hobbit.camus.events.records.EventHeader getHeader() {
    return header;
  }
   ...
   */
  public void setHeader(com.voole.hobbit.camus.events.records.EventHeader value) {
    this.header = value;
  }
  ...
  public static com.voole.hobbit.camus.events.records.TrackingMonitoringEvent.Builder newBuilder() {
    return new com.voole.hobbit.camus.events.records.TrackingMonitoringEvent.Builder();
  }
  
  /** Creates a new TrackingMonitoringEvent RecordBuilder by copying an existing Builder */
  public static com.voole.hobbit.camus.events.records.TrackingMonitoringEvent.Builder newBuilder(com.voole.hobbit.camus.events.records.TrackingMonitoringEvent.Builder other) {
    return new com.voole.hobbit.camus.events.records.TrackingMonitoringEvent.Builder(other);
  }
  
  /** Creates a new TrackingMonitoringEvent RecordBuilder by copying an existing TrackingMonitoringEvent instance */
  public static com.voole.hobbit.camus.events.records.TrackingMonitoringEvent.Builder newBuilder(com.voole.hobbit.camus.events.records.TrackingMonitoringEvent other) {
    return new com.voole.hobbit.camus.events.records.TrackingMonitoringEvent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TrackingMonitoringEvent>
    ...
    private com.voole.hobbit.camus.events.records.EventHeader header;
    ...
    private Builder() {
      super(com.voole.hobbit.camus.events.records.TrackingMonitoringEvent.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.voole.hobbit.camus.events.records.TrackingMonitoringEvent.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing TrackingMonitoringEvent instance */
    private Builder(com.voole.hobbit.camus.events.records.TrackingMonitoringEvent other) {
            super(com.voole.hobbit.camus.events.records.TrackingMonitoringEvent.SCHEMA$);
      if (isValidValue(fields()[0], other.header)) {
        this.header = (com.voole.hobbit.camus.events.records.EventHeader) data().deepCopy(fields()[0].schema(), other.header);
    ...
    /** Sets the value of the 'header' field */
    public com.voole.hobbit.camus.events.records.TrackingMonitoringEvent.Builder setHeader(com.voole.hobbit.camus.events.records.EventHeader value) {
    ...
    public com.voole.hobbit.camus.events.records.TrackingMonitoringEvent.Builder clearHeader() {
      header = null;
    ...
    /** Sets the value of the 'tier' field */
    public com.voole.hobbit.camus.events.records.TrackingMonitoringEvent.Builder setTier(java.lang.CharSequence value) {
    ...
    public com.voole.hobbit.camus.events.records.TrackingMonitoringEvent.Builder clearTier() {
      tier = null;
    ...
    /** Sets the value of the 'eventType' field */
    public com.voole.hobbit.camus.events.records.TrackingMonitoringEvent.Builder setEventType(java.lang.CharSequence value) {
    ...
    public com.voole.hobbit.camus.events.records.TrackingMonitoringEvent.Builder clearEventType() {
      eventType = null;
    ...
    /** Sets the value of the 'count' field */
    public com.voole.hobbit.camus.events.records.TrackingMonitoringEvent.Builder setCount(long value) {
    ...
    public com.voole.hobbit.camus.events.records.TrackingMonitoringEvent.Builder clearCount() {
    ...
    /** Sets the value of the 'beginTimestamp' field */
    public com.voole.hobbit.camus.events.records.TrackingMonitoringEvent.Builder setBeginTimestamp(long value) {
    ...
    public com.voole.hobbit.camus.events.records.TrackingMonitoringEvent.Builder clearBeginTimestamp() {
    ...
    /** Sets the value of the 'endTimestamp' field */
    public com.voole.hobbit.camus.events.records.TrackingMonitoringEvent.Builder setEndTimestamp(long value) {
    ...
    public com.voole.hobbit.camus.events.records.TrackingMonitoringEvent.Builder clearEndTimestamp() {
      ...
      try {
        TrackingMonitoringEvent record = new TrackingMonitoringEvent();
				record.header = fieldSetFlags()[0] ? this.header
						: (com.voole.hobbit.camus.events.records.EventHeader) defaultValue(fields()[0]);

...
public class OrderPlayAliveReqV2 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.List<com.voole.hobbit.avro.termial.OrderPlayAliveReqSrvV2> _srvs;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 10: _srvs = (java.util.List<com.voole.hobbit.avro.termial.OrderPlayAliveReqSrvV2>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.List<com.voole.hobbit.avro.termial.OrderPlayAliveReqSrvV2> getSrvs$1() {
    return _srvs;
  }
   ...
   * @param value the value to set.
   */
  public void setSrvs$1(java.util.List<com.voole.hobbit.avro.termial.OrderPlayAliveReqSrvV2> value) {
    this._srvs = value;
  }

  /** Creates a new OrderPlayAliveReqV2 RecordBuilder */
  public static com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder newBuilder() {
    return new com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder();
  }
  
  /** Creates a new OrderPlayAliveReqV2 RecordBuilder by copying an existing Builder */
  public static com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder newBuilder(com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder other) {
    return new com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder(other);
  }
  
  /** Creates a new OrderPlayAliveReqV2 RecordBuilder by copying an existing OrderPlayAliveReqV2 instance */
  public static com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder newBuilder(com.voole.hobbit.avro.termial.OrderPlayAliveReqV2 other) {
    return new com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderPlayAliveReqV2>
    ...
    private java.util.List<com.voole.hobbit.avro.termial.OrderPlayAliveReqSrvV2> _srvs;

    /** Creates a new Builder */
    private Builder() {
      super(com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder other) {
      super(other);
    ...
    private Builder(com.voole.hobbit.avro.termial.OrderPlayAliveReqV2 other) {
            super(com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.SCHEMA$);
      if (isValidValue(fields()[0], other.sessID)) {
        this.sessID = data().deepCopy(fields()[0].schema(), other.sessID);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'sessID' field */
    public com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder setSessID(java.lang.CharSequence value) {
    ...
    public com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder clearSessID() {
      sessID = null;
    ...
    /** Sets the value of the 'adjPlayTime' field */
    public com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder setAdjPlayTime(java.lang.Long value) {
    ...
    public com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder clearAdjPlayTime() {
      adjPlayTime = null;
    ...
    /** Sets the value of the 'accID' field */
    public com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder setAccID(java.lang.Long value) {
    ...
    public com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder clearAccID() {
      accID = null;
    ...
    /** Sets the value of the 'aliveTick' field */
    public com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder setAliveTick(java.lang.Long value) {
    ...
    public com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder clearAliveTick() {
      aliveTick = null;
    ...
    /** Sets the value of the 'seekNum' field */
    public com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder setSeekNum(java.lang.Long value) {
    ...
    public com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder clearSeekNum() {
      seekNum = null;
    ...
    /** Sets the value of the 'readNum' field */
    public com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder setReadNum(java.lang.Long value) {
    ...
    public com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder clearReadNum() {
      readNum = null;
    ...
    /** Sets the value of the 'unsuccRead' field */
    public com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder setUnsuccRead(java.lang.Long value) {
    ...
    public com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder clearUnsuccRead() {
      unsuccRead = null;
    ...
    /** Sets the value of the 'readPos' field */
    public com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder setReadPos(java.lang.Long value) {
    ...
    public com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder clearReadPos() {
      readPos = null;
    ...
    /** Sets the value of the 'sessAvgSpeed' field */
    public com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder setSessAvgSpeed(java.lang.Long value) {
    ...
    public com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder clearSessAvgSpeed() {
      sessAvgSpeed = null;
    ...
    /** Sets the value of the 'linkNum' field */
    public com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder setLinkNum(java.lang.Integer value) {
    ...
    public com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder clearLinkNum() {
      linkNum = null;
    ...
    /** Sets the value of the '_srvs' field */
    public com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder setSrvs$1(java.util.List<com.voole.hobbit.avro.termial.OrderPlayAliveReqSrvV2> value) {
    ...
    public com.voole.hobbit.avro.termial.OrderPlayAliveReqV2.Builder clearSrvs$1() {
      _srvs = null;
    ...
    public OrderPlayAliveReqV2 build() {
      try {
        ...
        record._srvs = fieldSetFlags()[10] ? this._srvs : (java.util.List<com.voole.hobbit.avro.termial.OrderPlayAliveReqSrvV2>) defaultValue(fields()[10]);
        return record;
      } catch (Exception e) {

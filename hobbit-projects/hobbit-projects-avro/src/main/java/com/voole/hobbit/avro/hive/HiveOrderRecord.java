...
public class HiveOrderRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** Creates a new HiveOrderRecord RecordBuilder */
  public static com.voole.hobbit.avro.hive.HiveOrderRecord.Builder newBuilder() {
    return new com.voole.hobbit.avro.hive.HiveOrderRecord.Builder();
  }
  
  /** Creates a new HiveOrderRecord RecordBuilder by copying an existing Builder */
  public static com.voole.hobbit.avro.hive.HiveOrderRecord.Builder newBuilder(com.voole.hobbit.avro.hive.HiveOrderRecord.Builder other) {
    return new com.voole.hobbit.avro.hive.HiveOrderRecord.Builder(other);
  }
  
  /** Creates a new HiveOrderRecord RecordBuilder by copying an existing HiveOrderRecord instance */
  public static com.voole.hobbit.avro.hive.HiveOrderRecord.Builder newBuilder(com.voole.hobbit.avro.hive.HiveOrderRecord other) {
    return new com.voole.hobbit.avro.hive.HiveOrderRecord.Builder(other);
  }
  
  /**
   * RecordBuilder for HiveOrderRecord instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HiveOrderRecord>
    ...
    private Builder() {
      super(com.voole.hobbit.avro.hive.HiveOrderRecord.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.voole.hobbit.avro.hive.HiveOrderRecord.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing HiveOrderRecord instance */
    private Builder(com.voole.hobbit.avro.hive.HiveOrderRecord other) {
            super(com.voole.hobbit.avro.hive.HiveOrderRecord.SCHEMA$);
      if (isValidValue(fields()[0], other.sessID)) {
        this.sessID = data().deepCopy(fields()[0].schema(), other.sessID);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'sessID' field */
    public com.voole.hobbit.avro.hive.HiveOrderRecord.Builder setSessID(java.lang.CharSequence value) {
    ...
    public com.voole.hobbit.avro.hive.HiveOrderRecord.Builder clearSessID() {
      sessID = null;
